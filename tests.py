...
class TestHelloApp(AsyncHTTPTestCase):
	...
	def test_vertical_win_condition(self):
		...
		self.assertTrue(result1['content']['move'] or result2['content']['move'])
		if result1['content']['move']:
			cells = [{"state":result1['content']['mark'] , "x": 0, "y": y} for y in range(0,5)]
			for index, cell in enumerate(cells):
				data3 = {"type": "user_move", "content": cell}
				_ = yield c.write_message(json.dumps(data3))
				yield gen.sleep(2)
			...
			cells = [{"state":result2['content']['mark'] , "x": 0, "y": y} for y in range(0,5)]
			for index, cell in enumerate(cells):
				data3 = {"type": "user_move", "content": cell}
				_ = yield c1.write_message(json.dumps(data3))
				yield gen.sleep(2)
	...
	@gen_test(timeout=40)
	def test_diagonal1_win_condition(self):
		self.assertEqual(self.handler._registry,[])
		c = yield self._mk_client()
		c1 = yield self._mk_client()
		data = {"type":"new_user","content":"user1"}
		...
		self.assertTrue(result1['content']['move'] or result2['content']['move'])
		if result1['content']['move']:
			cells = [{"state":result1['content']['mark'] , "x": y, "y": y} for y in range(0,5)]
			for index, cell in enumerate(cells):
				data3 = {"type": "user_move", "content": cell}
				_ = yield c.write_message(json.dumps(data3))
				yield gen.sleep(2)
			...
			cells = [{"state":result2['content']['mark'] , "x": y, "y": y} for y in range(0,5)]
			for index, cell in enumerate(cells):
				data3 = {"type": "user_move", "content": cell}
				_ = yield c1.write_message(json.dumps(data3))
				yield gen.sleep(2)
	...
	@gen_test(timeout=40)
	def test_diagonal2_win_condition(self):
		self.assertEqual(self.handler._registry,[])
		c = yield self._mk_client()
		c1 = yield self._mk_client()
		data = {"type":"new_user","content":"user1"}
		...
		self.assertTrue(result1['content']['move'] or result2['content']['move'])
		if result1['content']['move']:
			cells = [{"state":result1['content']['mark'] , "x": y, "y": 5-y} for y in range(0,5)]
			for index, cell in enumerate(cells):
				data3 = {"type": "user_move", "content": cell}
				_ = yield c.write_message(json.dumps(data3))
				yield gen.sleep(2)
			...
			cells = [{"state":result2['content']['mark'] , "x": y, "y": 5-y} for y in range(0,5)]
			for index, cell in enumerate(cells):
				data3 = {"type": "user_move", "content": cell}
				_ = yield c1.write_message(json.dumps(data3))
				yield gen.sleep(2)
